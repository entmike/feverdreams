...
blueprint = Blueprint('personalfeed', __name__)

@blueprint.route("/v3/personalfeed/<amount>", methods=["GET"], defaults={"page": 1})
@blueprint.route("/v3/personalfeed/<amount>/<page>")
@requires_auth
def v3_personalfeed(amount, page):
    ...
    with db.get_database() as client:
        ...
        r = list(client.database.personal_pieces.aggregate(operations))
