...
export default function MyWorkspacePage(props) {
  let {isAuthenticated, token, user, permissions} = props
  ...
  return (
    <>
      ...
      <Skeleton isLoaded={!loading}>
        <FeedList pieces = {data} loading={loading} isAuthenticated={isAuthenticated} token={token} user={user} mode={"review"} onDelete={handleOnDelete} onChange={handleOnChange} permissions={permissions}/>
      </Skeleton>
