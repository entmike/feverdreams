...
import { Avatar, AvatarBadge, Box, Flex, Image, HStack, IconButton, Button, Badge, Wrap, WrapItem} from '@chakra-ui/react';
  ...
  useEffect(() => {
    ...
    <Box style={maskStyle}>
        ...
        <Wrap style={{
          ...
          {piece.params && piece.params && 
            <WrapItem>
              <MutatePopover token = {token} piece = {piece} />
            </WrapItem>
          }
