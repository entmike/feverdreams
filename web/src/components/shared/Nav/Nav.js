...
export function Nav(props) {
  ...
  const starterJob={
    algo: "stable",
    uuid: "39168116336bbcafaa7104f9961712e11c7612a2ea1f2671bf4c98057c2574c1",
    nsfw: false,
      ...
      <Box bg={useColorModeValue('gray.100', 'gray.900')} px={4}>
        ...
        <Flex h={16} alignItems={'center'}>
          ...
          <Menu>
              ...
              <MutatePopover token={token} piece = {starterJob} buttonText="Create"/>
            ...
            {isAuthenticated && (
              <Menu>
                ...
                <MenuList>
                  ...
                  >
                    My Jobs {myInfo.queue > 0 && <Badge ml={2} variant={"outline"} colorScheme={"green"}>{myInfo.queue}</Badge>} {myInfo.backlog > 0 && <Badge ml={2} variant={"outline"} colorScheme={"red"}>{myInfo.backlog}</Badge>}
                  </MenuItem>
                  <MenuItem
                    onClick={() =>
                  ...
                  <MenuDivider />
                  <MenuItem
                  onClick={() => window.open(`https://discord.gg/feverdreams`)}
                  >
                    Discord
                  </MenuItem>
                  <MenuItem
